...
parser.add_argument('--root_path', type=str,
                    default='/mnt/fs2/2019/Takamuro/db/Transient_Attributes')
parser.add_argument('--save_path', type=str, default='cp/estimator_Transient_Attributes')
...
from dataset import TransientAttributes
from ops import l1_loss, adv_loss


if __name__ == '__main__':
    name = 'TransientAttributes_{}_PreTrained-{}'.format(args.name, args.pre_trained)
    ...
    loader = lambda s: TransientAttributes(args.root_path, df_sep[s],
                                        cols, transform[s])
