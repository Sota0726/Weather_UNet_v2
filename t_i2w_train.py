...
# args = parser.parse_args(args=['--augmentation', '--dataset', 'flicker', '--name', 'debug_base'])
...
class WeatherTransfer(object):
    ...
    def __init__(self, args):
        ...
        self.name = 'I2W_{}_aug-{}_sampler-{}_loss_lamda-c{}-w{}_b1-{}_b2-{}'.format(self.args.name, self.args.augmentation, self.args.sampler, self.args.loss_lamda_cw[0],
