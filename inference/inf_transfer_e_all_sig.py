...
if __name__ == '__main__':
    ...
    save_path_all = os.path.join('/mnt/fs2/2019/Takamuro/m2_research/weather_transferV2/results/eval_transfer', 'est',
                                args.cp_path.split('/')[-2].split('_GDratio')[0],
                                args.cp_path.split('/')[-1].split('.pt')[0], 'all_sig')
    save_path_each = os.path.join('/mnt/fs2/2019/Takamuro/m2_research/weather_transferV2/results/eval_transfer', 'est',
                             args.cp_path.split('/')[-2].split('_GDratio')[0],
